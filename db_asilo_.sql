...
INSERT INTO `ancianos` VALUES (1,'ISRAEL','MUÑOZ','URIAS','VIERNES, 15 DE ENERO DE 2016','MASCULINO','CARTA DE NATURALIZACIÓN','SI','EXTERNO','EDMUNCO','MUÑOZ','urias','6685454346','LUZ','CREDENCIAL PARA JUBILADOS Y PENSIONADOS','HIJO','NADA','BUENO','Edmundo Muñoz Urias','Alfonsina Elisa Casal Moreira','Alejandra Garcia','ACTIVADO'),(2,'AURORA','URIAS','CASTILLO','VIERNES, 15 DE ENERO DE 2016','MASCULINO','CARTILLA DEL SERVICIO MILITAR NACIONAL LIBERADA','SI','INTERNO','E','WW','wewe','E','WE','CREDENCIAL DEL INAPAM','HIJA','E','E','Aurora Urias Castillo','Abel Braulio Dorens Viera','Alejandra Garcia','ACTIVADO'),(3,'DAVID','GARCIA','SOLIS','VIERNES, 15 DE ENERO DE 2016','MASCULINO','CARTILLA DEL SERVICIO MILITAR NACIONAL LIBERADA','NO','EXTERNO','ISRAEL','MUÑOZ','URIAS','88888','LA CASA','CREDENCIAL DEL INAPAM','HERMANO','NA HAY','EL PACIENTE ENTA EN BIEN ESTADO','Israel Muñoz Urias','Alfonsina Elisa Casal Moreira','Alejandra Garcia','ACTIVADO'),(4,'W','W','W','E','FEMENINO','CARTILLA DEL SERVICIO MILITAR NACIONAL LIBERADA','SI','INTERNO','WM','W','w','W','W','CREDENCIAL DEL INAPAM','HIJO','W','WMM',NULL,NULL,NULL,'ACTIVADO');
...
INSERT INTO `aux_maquinaria` VALUES (1,'Jeringas',9),(1,'e',10),(1,'Jeringas',11),(1,'w',12),(1,'Jeringas',13),(1,'Respirador',14),(3,'Respirador',15),(3,'Jeringas',16);
...
CREATE TABLE `aux_medicamento` (
  ...
  `conce` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`conce`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 DELAY_KEY_WRITE=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `aux_medicamento` VALUES (1,'Acarbosa (Oral)',6,'w',9),(1,'Eflornitina (Por Inyección)',0,'e',10),(1,'Aceite de Silicona 5000 Centistokes (Oftálmic',0,'w',11),(3,'Agentes Colecistográficos (Diagnóstico -- Ora',20,'2',28),(3,'Agentes Antitiroideos (Orales)',0,'m',29);
...
INSERT INTO `aux_terapias` VALUES (1,'2',1),(3,'Estimulación Cognitiva',6),(3,'Activación Y Terapia Física',7);
...
-- Dump completed on 2016-01-19 12:20:00
